...
// dialogue
//const static int pointerTableStart = 0x8B8;
//const static int numPointerTableEntries = 0x57;
// status bar
const static int pointerTableStart = 0x150F7;
const static int numPointerTableEntries = 0x1A;
